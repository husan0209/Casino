...
7. ~~После MVP: GAP-22/24/25/26~~ **2026-08-31: GAP-22 (4-слойка wallet) и GAP-24 (тесты + E2E) закрыты**; остались GAP-25 (ESLint-строгость), GAP-26 (алиасы — вместе с деплой-настройкой), GAP-28; email-воркер отдельным процессом, rich HTML-шаблоны.
