...
- [x] Часть 5 Frontend Web – ~97% – витрина (last played, бейджи NEW/HOT, лента провайдеров, превью по «i»)/каталог с infinite scroll/избранное/поиск/провайдеры/ЛК (4 вкладки: данные+аватар, безопасность — смена пароля, сессии, настройки)/кошелёк/KYC/история + geo/wallet stores, DepositSheet/LaunchCurrencySheet/WalletSwitcher, play-страница с планкой баланса, SEO (OG/noindex); GAP-52/53 закрыты 2026-09-13; тесты: 78 web (72 unit + 6 DOM) (GAP-44 + контракты casino.api/users.api + desktop-nav). Десктоп-иконпанель §4.5 (pin/hover), поиск в хедере + Ctrl/⌘K, last played и провайдеры в поиске, auth-страницы без казино-обвязки §4.7 (GAP-54 закрыт 2026-09-14). URL-фильтры каталога + сортировка + рабочий сброс и чипы/полки главной (§6.1/§7) закрыты 2026-09-14 в рамках GAP-55; открыто в GAP-55: экраны ошибок запуска, маршрут истории транзакций с фильтрами, фильтры ставок, performance-хвост §22, капча после 5 неудач, WithdrawSheet как sheet
