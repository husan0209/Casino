...
- [~] Часть 5 Frontend Web – ~85% – витрина/ЛК/кошелёк/KYC/история + geo/wallet stores, DepositSheet/LaunchCurrencySheet, play-страница; полный 90-сек флоу частично (TZ-07/09); тесты: 39 (чистые функции + DOM-тесты DepositSheet/KYC-страницы — GAP-44 закрыт 2026-09-09)
